 ...
 *  * Last modified 17.09.2022, 21:31
 *
 */
...
public class WidgetList extends AppWidgetProvider {
    ...
    private void updateAppWidget(@NonNull Context context, @NonNull AppWidgetManager appWidgetManager, int appWidgetId, Bundle newOptions) {
